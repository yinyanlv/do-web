...
@Directive({
  selector: '[jPerfectScrollbar]'
})
export class JPerfectScrollbarDirective implements AfterViewInit, OnDestroy {
  ...
  @Input()
  set jPerfectScrollbarOptions(value) {
    this._options = _.merge({}, this._options, value);
  }

  get jPerfectScrollbarOptions(): any {
    return this._options;
  }

  @Input('jPerfectScrollbar')
  ...
  ngAfterViewInit(): void {
    ...
    if (this.jPerfectScrollbarOptions.updateOnRouteChange) {
      this._router.events
        .pipe(
